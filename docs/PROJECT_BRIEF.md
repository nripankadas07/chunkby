        ...
        chunkby exists to solve a narrow, inspectable developer-tooling problem:
        Iterator helpers — chunk by size, sliding windows, batch by predicate, partition, pairwise, take/drop/nth, flatten. Zero dependencies.
        ...
        Topics: chunking, iterator, itertools, python, windows, zero-dependencies
